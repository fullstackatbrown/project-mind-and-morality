...
export default function ResearchTopicsPage() {
    return (
      ...
      `}</style>
            ...
            <section className="max-w-6xl w-full px-8 pt-20 pb-24">
                <h1 className="text-5xl font-semibold text-teal-800 text-center mb-16">
                    Research Topics
                </h1>

                <h2 className="text-4xl font-semibold orange-text text-center mb-8">
                    Understanding Social and Moral Development
                </h2>

                <div className="max-w-4xl mx-auto mb-14">
                    <p className="text-xl text-teal-800 leading-10">
              ...
              these moral concepts develop and evolve across different cultures and social contexts?
                ...
                <div className="max-w-4xl mx-auto space-y-16">
                    ...
                    <div>
                        ...
                        <p className="text-xl text-teal-800 leading-10 mb-6">
