...
export default function Footer() {
  return (
    <footer className="relative h-[480px] w-full overflow-hidden bg-[linear-gradient(180deg,transparent_0%,#F9C85F_100%)]">
      <div className="mx-auto relative h-full max-w-[1512px] px-[88px]">
