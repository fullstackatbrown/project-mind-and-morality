...
export default function GetInvolvedStudentsPage() {
  return (
    <main className={`${dmSans.className} w-full bg-[#f5f5f5] text-[#3f97a4]`}>
      <div className="mx-auto max-w-[1175px] px-6 pb-24 pt-10 md:px-8 md:pb-28 md:pt-14 lg:px-0 lg:pt-[52px]">
        <h1 className="mb-16 text-center text-[40px] font-bold leading-[1.1] tracking-[-0.02em] text-[#3f97a4] md:mb-20 md:text-[50px]">
          Get Involved for Students
        </h1>

        <section className="mb-16 grid gap-8 md:mb-20 md:grid-cols-[615px_500px] md:items-start md:justify-center md:gap-[60px]">
          <div>
        ...
        <section className="mb-16 grid gap-8 md:mb-20 md:grid-cols-[615px_500px] md:items-start md:justify-center md:gap-[60px]">
          <div>
            ...
            <div className="mt-6 max-w-[595px] rounded-[40px] bg-[#bcf1f5] px-6 py-7 text-[22px] font-medium leading-[36px] text-[#3f97a4] md:mt-8 md:px-11">
