    ...
    <div className="bg-white border border-zinc-200 rounded-2xl overflow-hidden flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-100">
        ...
        <a
          ...
          className="ml-auto"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 text-zinc-400 hover:text-zinc-600 transition-colors">
      ...
      <div className="flex items-center gap-4 px-4 pt-3">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6 text-zinc-600">
